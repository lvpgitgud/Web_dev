<%-- 
    ...
    Created on : Nov 8, 2025, 10:09:28 AM
    Author     : Admin
--%>
...
<%
    ...
    if (studentCode != null && !studentCode.isEmpty()) {
        if (!studentCode.matches("[A-Z]{2}[0-9]{3,}")) {
            response.sendRedirect("add_student.jsp?error=Invalid ID format, student code MUST follows pattern: 2 uppercase letters plus 3 digits");
            return;
        }
    }
